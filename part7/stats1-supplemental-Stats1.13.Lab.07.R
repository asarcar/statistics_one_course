...
#   Moderation analysis
#     Example
#     An experimental research investigation of the effects of stereotype
#     threat on intelligence testing 
#       Dependent variable (Y) is score on an intelligence test (IQ)
#       Independent variable (X) is the treatment condition
#       (3 levels: control, explicit threat, implicit threat)
...
#   Mediation analysis
#     Example
#       An experimental research investigation of the effects of
#       stereotype threat on intelligence testing 
#         Dependent variable (Y) is score on an intelligence test (IQ)
#         Independent variable (X) is the treatment condition
#         (2 levels: control, threat)
...
# 1         "control"   134  91   -8.08         0    0
# 55        "threat1"   80   126  26.92         1    0
# 105       "threat2"   57   93   -6.08         0    1

MOD$subject <- factor(MOD$subject)
...
# We could also use the aov function (for analysis of variance) followed
# by the TukeyHSD function (Tukey's test of pairwise comparisons,
# which adjusts the p value to prevent infaltion of Type I error rate)
model0a <- aov(MOD$IQ ~ MOD$condition)
summary(model0a)
TukeyHSD(model0a)

# Moderation analysis (uncentered): model1 tests for "first-order effects";
# model2 tests for moderation
...
MED$subject <- factor(MED$subject)
