...
# Example
# The data are based on a mock jury study conducted by Shari Diamond
# and Jonathan Casper. Participants (N = 100) watched a videotaped
# sentencing phase trial in which the defendant had already been found guilty  
# The issue for the jurors to decide was whether the defendant deserved
# the death penalty. These data were collected “pre-deliberation” (i.e., each
# juror was asked to provide his/her vote on the death penalty verdict, then
# the jurors met as a group to decide the overall jury verdict)
...
#
# Table
# DV: belief as to the importance of:
# danger: future dangerousness of the defendant
# rehab: rehabilitation as goal of sentencing
# punish: punishment as goal of sentencing
# gendet: will sentencing deter general public?
# spedet: will sentencing deter defendant?
# incap: incapcitation as a goal of sentencing?
